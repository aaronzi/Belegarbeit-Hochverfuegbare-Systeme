...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.75\textwidth]{Bilder/2. Inbetriebnahme/1. Grundlagen/(1.2) Reale Anlage.jpg}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.4\textwidth]{Bilder/2. Inbetriebnahme/2. Neues Projekt anlegen/(2.1) TIA Portal V17 oeffnen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.95\textwidth]{Bilder/2. Inbetriebnahme/2. Neues Projekt anlegen/(2.2) Neues Projekt erstellen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.6\textwidth]{Bilder/2. Inbetriebnahme/2. Neues Projekt anlegen/(2.3) Projektansicht oeffnen.png}}
...
\begin{figure}[H]
   ...
   \begin{minipage}[b]{.4\linewidth}
        \centering
        \fbox{\includegraphics[width=1\linewidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.1 S7-1500 hinzufügen/(3.1.1) Neues Geraet hinzufuegen.png}}
   ...
   \begin{minipage}[b]{.4\linewidth}
        \centering
        \fbox{\includegraphics[width=1\linewidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.1 S7-1500 hinzufügen/(3.1.2) SPS auswaehlen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.7\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.2 Kommunikation herstellen/(3.2.1) Hardware ermitteln.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.6\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.2 Kommunikation herstellen/(3.2.2) Kommunikation aufnehmen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.75\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.2 Kommunikation herstellen/(3.2.3) Vertrauenswuerdigkeit zulassen.PNG}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.75\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.2 Kommunikation herstellen/(3.2.4) Voreinstellungen nicht zulassen.PNG}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.3 Security-Einstellungen der S7-1500/(3.3.1) Security Einstellungen (1).png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.3 Security-Einstellungen der S7-1500/(3.3.2) Security Einstellungen (2).png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.3 Security-Einstellungen der S7-1500/(3.3.3) Security Einstellungen (3).png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.3 Security-Einstellungen der S7-1500/(3.3.4) Passwortschutz entfernen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.45\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der S7-1500/(3.4.1) PROFINET-Schnittstelle.jpg}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.9\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der S7-1500/(3.4.2) IP-Adresse der S7 einstellen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.9\textwidth]{Bilder/2. Inbetriebnahme/3. Konfiguration der S7-1500/3.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der S7-1500/(3.4.3) PROFINET-Geraetename S7 einstellen.png}}
...
\begin{figure}[H]
   ...
   \begin{minipage}[b]{.4\linewidth}
        \centering
        \fbox{\includegraphics[width=0.4\linewidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.1 ET 200 SP hinzufügen/(4.1.1) Modulbezeichnung am Beispiel des IM 155-Moduls.jpg}}
   ...
   \begin{minipage}[b]{.4\linewidth}
        \centering
        \fbox{\includegraphics[width=1.0\linewidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.1 ET 200 SP hinzufügen/(4.1.2) Dezentrale Peripherie hinzufuegen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.9\textwidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.2 Module hinzufügen/(4.2.1) Übersicht aller Module der dezentralen Peripherie.jpg}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.9\textwidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.2 Module hinzufügen/(4.2.2) Elemente der dezentralen Peripherie hinzufuegen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.75\textwidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.2 Module hinzufügen/(4.2.3) Potenzialgruppe aendern.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.65\textwidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.3 Geräteversionen tauschen/(4.3.1) Geraeteversion tauschen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.65\textwidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.3 Geräteversionen tauschen/(4.3.2) Geraeteversion tauschen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.2\textwidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der ET 200 SP/(4.4.1) Bezeichnung der PROFINET-Schnittstelle.jpg}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.95\textwidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der ET 200 SP/(4.4.2) IP-Adresse der ET 200 SP.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.95\textwidth]{Bilder/2. Inbetriebnahme/4. Konfiguration der ET 200 SP/4.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der ET 200 SP/(4.4.3) PROFINET-Geraetename der ET 200 SP.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/2. Inbetriebnahme/5. PROFINET-Verbindung/5.1 Verbindung herstellen/(5.1.1) PROFINET-Verbindung ziehen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/2. Inbetriebnahme/5. PROFINET-Verbindung/5.2 Fehlersicherheit aktivieren/(5.2.1) Fehlersicherheit aktivieren.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/2. Inbetriebnahme/5. PROFINET-Verbindung/5.3 Überprüfung des internen PROFINET-Gerätenamens der ET 200SP/(5.3.1) Ueberpruefung der richtigen Namen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/2. Inbetriebnahme/5. PROFINET-Verbindung/5.4 Überprüfung der IP-Adressen der Geräte/(5.4.1) Ueberpruefung der richtigen Adressen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.6\textwidth]{Bilder/2. Inbetriebnahme/6. Laden und Übersetzen der Hard- und Software/(6.1) Uebersetzen.PNG}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.6\textwidth]{Bilder/2. Inbetriebnahme/6. Laden und Übersetzen der Hard- und Software/(6.2) Laden.PNG}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.95\textwidth]{Bilder/2. Inbetriebnahme/7. Vergabe der PROFIsafe-Adressen/(7.1) Vergabe der PROFIsafe-Adressen.PNG}}

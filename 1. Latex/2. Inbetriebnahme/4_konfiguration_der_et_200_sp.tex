...
\begin{figure}[H]
   ...
   \begin{minipage}[b]{.4\linewidth}
        \centering
        \fbox{\includegraphics[width=0.4\linewidth]{Bilder/4. Konfiguration der ET 200 SP/4.1 ET 200 SP hinzufügen/(10.1) Modulbezeichnung am Beispiel des IM 155-Moduls.jpg}}
   ...
   \begin{minipage}[b]{.4\linewidth}
        \centering
        \fbox{\includegraphics[width=1.1\linewidth]{Bilder/4. Konfiguration der ET 200 SP/4.1 ET 200 SP hinzufügen/(10.2) Dezentrale Peripherie hinzufuegen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.9\textwidth]{Bilder/4. Konfiguration der ET 200 SP/4.2 Module hinzufügen/(10.3) Übersicht aller Module der dezentralen Peripherie.jpg}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.9\textwidth]{Bilder/4. Konfiguration der ET 200 SP/4.2 Module hinzufügen/(10.4) Elemente der dezentralen Peripherie hinzufuegen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.75\textwidth]{Bilder/4. Konfiguration der ET 200 SP/4.2 Module hinzufügen/(11) Potenzialgruppe aendern.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.65\textwidth]{Bilder/4. Konfiguration der ET 200 SP/4.3 Geräteversionen tauschen/(12.1) Geraeteversion tauschen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.65\textwidth]{Bilder/4. Konfiguration der ET 200 SP/4.3 Geräteversionen tauschen/(12.2) Geraeteversion tauschen.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.2\textwidth]{Bilder/4. Konfiguration der ET 200 SP/4.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der ET 200 SP/(13.1) Bezeichnung der PROFINET-Schnittstelle.jpg}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=1\textwidth]{Bilder/4. Konfiguration der ET 200 SP/4.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der ET 200 SP/(13.2) IP-Adresse der ET 200 SP.png}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=1\textwidth]{Bilder/4. Konfiguration der ET 200 SP/4.4 IP-Adresse und Vergabe des PROFINET-Gerätenamen der ET 200 SP/(13.3) PROFINET-Geraetename der ET 200 SP.png}}
